...
O principal objetivo foi praticar a estrutura semântica da web, o design responsivo básico e a organização de código. Cada série listada possui um título, uma breve sinopse, e um pôster/imagem de capa.

✨ Principais Recursos
Lista Curada: Exibe uma coleção de séries selecionadas manualmente e algumas com ajuda do Gemini.

Estrutura Simples: Uso de elementos HTML básicos (<header>, <section>, <footer>, <ul>, <li>) para uma estrutura limpa.
